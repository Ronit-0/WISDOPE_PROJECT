...
def set_custom_style(main_bg):
    ...
    st.markdown(f"""
        ...
        /* Force Dark Mode UI and Background Image */
        .stApp {{
        ...
        /* Make all links bright yellow/gold for visibility */
        a {{
...
# Call the style function with your background image
...
with tab5:
    ...
    with col2:
        ...
        # Re-using whatsapp_url from Tab 4
        whatsapp_url = f"https://wa.me/917044443309?text={whatsapp_msg.replace(' ', '%20')}"
